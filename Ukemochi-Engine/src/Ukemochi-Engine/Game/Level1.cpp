...
namespace Ukemochi
{
	...
	{
		double collision_percent = static_cast<double>((collision / loop) * 100.f);
		double physics_percent = static_cast<double>((physics / loop) * 100.f);
		double graphics_percent = static_cast<double>((graphics / loop) * 100.f);
